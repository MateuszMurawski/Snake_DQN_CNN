...
class Game:
    ...
    def gameOver(self):
        ...
        agent.Agent.newDataAboutGame(self.direction, self.getScreenOnGame(), -1)
        self.newGame()

    def newGame(self):
        self.snakePosition = [self.windowX / 4 + self.unitSize, self.windowY / 2]
        self.snakeBody = [[self.windowX / 4, self.windowY / 2], [self.windowX / 4 - self.unitSize, self.windowY / 2], [self.windowX / 4 - self.unitSize * 2, self.windowY / 2]]
        self.fruitPosition = [random.randrange(1, (self.windowX // self.unitSize)) * self.unitSize, random.randrange(1, (self.windowY // self.unitSize)) * self.unitSize]
    ...
    def startGame(self):
        ...
        while True:
            ...
            agent.Agent.newDataAboutGame(self.direction, self.getScreenOnGame(), self.score)
            ...
            self.changeTo = agent.Agent.getNewDirection()
